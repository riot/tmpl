// Brackets Management
// -------------------
// The brackets function returns a string or regex based on the current
// riot brackets.
...
var brackets = function (onchange, UNDEF) {
  ...
  var
    ...
    //#if LOCK_SUPPORT
    _lock  = UNDEF,               // lock to this brackets if not empty
    //#endif
  ...
  /**
   * Reconfigures the internal state immediately.
   * @param {string} pair - The new brackets pair
   */
  function _set(pair) {
  ...
  _brackets.split = function split(str, tmpl) {
    ...
    var
      ...
      re = _pairs[$_RIX_OPEN]     // start with opening bracket
  ...
  _brackets.set = _set                  // or better use this
