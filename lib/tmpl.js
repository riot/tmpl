...
//#endif
  ...
  // Instantiate the brackets function
  brackets = brackets(_changebp)
  _changebp(brackets.array())     // set _bp & _reKeys
...
//#endif
  ...
  /**
   * On change of brackets
   * @param {Array} bp - New brackets array
   * @private
   */
...
//#endif
  ...
  function _wrapExpr(expr, asText, key) {
    ...
    expr = expr.replace(JS_VARNAME, function (match, p, mvar) {
      if (mvar) {
        var s = tb ? FALSE : RegExp.rightContext         // check only if needed
